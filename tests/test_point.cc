...
{
    using point1 = dim::point<double, dim::mechanical_dimension<1, 0, 0>, 1>;
    using point2 = dim::point<double, dim::mechanical_dimension<1, 0, 0>, 2>;
    using point3 = dim::point<double, dim::mechanical_dimension<1, 0, 0>, 3>;
    using point4 = dim::point<double, dim::mechanical_dimension<1, 0, 0>, 4>;
...
{
    using float_point_t = dim::point<float, dim::mechanical_dimension<1, 0, 0>, 3>;
    using double_point_t = dim::point<double, dim::mechanical_dimension<1, 0, 0>, 3>;
...
{
    using point_t = dim::point<double, dim::mechanical_dimension<1, 0, 0>, 3>;
    point_t{1.0, 2.0, 3.0};
...
{
    using tuple_t = dim::point<double, dim::mechanical_dimension<0, 0, 0>, 3>;
    using point_t = dim::point<double, dim::mechanical_dimension<1, 0, 0>, 3>;
...
{
    using float_point_t = dim::point<float, dim::mechanical_dimension<1, 0, -1>, 3>;
    using double_point_t = dim::point<double, dim::mechanical_dimension<1, 0, -1>, 3>;
...
TEST_CASE("point: exposes spatial dimension")
{
    ...
    using point3 = dim::point<double, dim::mechanical_dimension<1, 0, 0>, 3>;
    using point4 = dim::point<double, dim::mechanical_dimension<1, 0, 0>, 4>;
    using point9 = dim::point<double, dim::mechanical_dimension<1, 0, 0>, 9>;
...
TEST_CASE("point: provides squared_distance function")
{
    ...
    CHECK(dim::squared_distance(p, q) == area_t{5 * 5 + 3 * 3 + 1 * 1});
}

TEST_CASE("point: provides distance function")
{
    using point_t = dim::point<double, dim::mechanical_dimension<1, 0, 0>, 2>;
    using length_t = dim::scalar<double, dim::mechanical_dimension<1, 0, 0>>;

    point_t const p{1, 2};
    point_t const q{4, 6};
    CHECK(dim::distance(p, q) == length_t{5});
}
...
TEST_CASE("point: example: two-body simulation")
{
    ...
    using grav_constant_t = dim::scalar<double, dim::mechanical_dimension<3, -1, -2>>;
    ...
    using point_t = dim::point<double, dim::mech::length, 3>;
    ...
    force_t const force = -G * a_mass * b_mass * r / dim::pow<3>(dim::norm(r));
    a_momentum += force * dt;
    b_momentum += -force * dt;
